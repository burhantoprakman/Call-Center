...
class JoinThisWeekCell : UITableViewCell {
    ...
    var delegate: JoinWeekCellDelegate?
...
protocol JoinWeekCellDelegate {
    func tebrikButtonClicked( _ cell : JoinThisWeekCell)
    func instaButtonClicked( _ cell : JoinThisWeekCell)
    func faceButtonClicked( _ cell : JoinThisWeekCell)
}
